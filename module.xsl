...
<xsl:variable name="path" select="/module/@path"/>
<xsl:variable name="module" select="/module/name/text()"/>
<xsl:variable name="namespace" select="/module/namespace/text()"/>
<!--<xsl:variable name="class" select="/api/class/text()"/>
<xsl:variable name="instance" select="/api/class/@instance"/>-->
<xsl:template match="/api">
<html>
	<head>
		<title><xsl:if test="$namespace"><xsl:value-of select="$namespace"/>.</xsl:if><xsl:value-of select="$module"/></title>
